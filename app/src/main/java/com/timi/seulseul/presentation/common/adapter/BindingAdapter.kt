...
fun ImageView.bindLineImage(line: String?) {
    when(line) {
        ...
        "수인.분당선" -> setImageResource(R.drawable.ic_subway_route_line_suin)
        ...
        "서해선(대곡-원시)" -> setImageResource(R.drawable.ic_subway_route_line_west)
        "서해선(일산-원시)" -> setImageResource(R.drawable.ic_subway_route_line_west)
...
fun View.bindLineColor(line: String?) {
    when(line) {
        ...
        "수인.분당선" -> setBackgroundColor(ContextCompat.getColor(context, R.color.subway_suin))
        ...
        "서해선(대곡-원시)" -> setBackgroundColor(ContextCompat.getColor(context, R.color.subway_west))
        "서해선(일산-원시)" -> setBackgroundColor(ContextCompat.getColor(context, R.color.subway_west))
